...
class model_result:
    def __init__(self):
        # 加载已经训练好的模型
        self.gbdt = pk.load(open(r'train_model\gbdt.pkl','rb'))
        self.LR = pk.load(open(r'train_model\LR.pkl','rb'))
        self.svm = pk.load(open(r'train_model\svm.pkl', 'rb'))
        self.label2id = pk.load(open(r'train_model\label2id.pkl', 'rb'))
        self.vector = pk.load(open(r'train_model\vector.pkl', 'rb'))
